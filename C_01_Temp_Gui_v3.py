...
class Converter:
    ...
    def __init__(self):
        ...
        instructions = ("Please enter a temperature below and then press one of the buttons to "
                        "convert it from Centigrade to Fahrenheit")
    ...
    def check_temp(self, min_temp):
        ...
        # checks that amount be converted is a number above absolute zero
        try:
